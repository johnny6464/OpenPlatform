...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.label.setGeometry(QtCore.QRect(20, 30, 61, 30))
        self.label.setObjectName("label")
        self.label_2 = QtWidgets.QLabel(self.centralwidget)
        self.label_2.setGeometry(QtCore.QRect(190, 30, 61, 30))
        ...
        self.del_button.setStyleSheet("background-color: #FFD700;")
        self.nickname_lineEdit = QtWidgets.QLineEdit(self.centralwidget)
        self.nickname_lineEdit.setGeometry(QtCore.QRect(70, 30, 113, 30))
